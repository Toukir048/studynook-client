...
const RoomCard = ({ room }) => {
  ...
  return (
    <article className="flex h-full flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-xl hover:shadow-slate-200">
      ...
      <div className="flex flex-1 flex-col p-5">
        <h3 className="text-xl font-bold text-slate-950">{roomName}</h3>
